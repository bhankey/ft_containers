...
#ifndef FT_CONTAINERS_CONTAINERS_SET_HPP_
#define FT_CONTAINERS_CONTAINERS_SET_HPP_
...
class Set {
 ...
 public:
  ...
  Set(const Set &other) : rb_tree_(other.rb_tree_), compare_(other.compare_) {
...
bool operator==(const Set<Key, Compare, Alloc> &lhs, const Set<Key, Compare, Alloc> &rhs) {
  ...
  typename ft::Set<Key, Compare, Alloc>::const_iterator lit = lhs.begin(), rit = rhs.begin();
...
#endif //FT_CONTAINERS_CONTAINERS_SET_HPP_
